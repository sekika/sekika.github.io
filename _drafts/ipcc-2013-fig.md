...
E.8 気候の安定化、気候変動の不可避性と、気候変動の不可逆性二酸化炭素の累積排出量によって、21 世紀後半及びその後の世界平均の地表面の温暖化の大部分が決定づけられる（図 SPM.10 を参照）。気候変動の特徴の大部分は、たとえ二酸化炭素の排出が停止したとしても、何世紀にもわたって持続するだろう。このことは、過去、現在、及び将来の二酸化炭素の排出の結果による、大規模で数世紀にわたる気候変動の不可避性を表している。
