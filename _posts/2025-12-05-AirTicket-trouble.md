---
layout: post-en
title: Changing an Airline Ticket
date: 2025-12-05 09:33:45 +0000
ja: /2025/12/04/AirTicket-trouble/
tags:
- english
- travel
---
...
To state the conclusion first: if you miss your connecting flight, the procedure is to find the counter of the airline operating your international flight; if the counter is closed, you then locate the airline’s office. However, depending on the airport, even the official map may not show where airline offices are located, and airport staff may tell you they “don’t know.” Even so, you have to persist and find it yourself. Illustration by [Claude](https://claude.ai/):

<img alt="Illustration" src="/img/20251205-AirTicket-trouble.svg" style="width: min(100%, 800px);  height: auto; margin:auto; display: block" />

There are several airlines that fly between Tokyo and Rio de Janeiro, but I chose the cheapest option I found online, Ethiopian Airlines, booked through Google → Booking.com. The itinerary was Haneda (Tokyo) → Addis Ababa → São Paulo, then a domestic flight to Rio de Janeiro after entering Brazil. I left Haneda on May 4, 2025, arriving at [São Paulo/Guarulhos International Airport](https://en.wikipedia.org/wiki/S%C3%A3o_Paulo/Guarulhos_International_Airport) on May 5 at 16:20 on Ethiopian Airlines flight ET506, then connecting to [Gol Airlines](https://en.wikipedia.org/wiki/Gol_Linhas_A%C3%A9reas_Inteligentes) flight G31924 departing at 18:00 for Rio. Even at the time of booking, I felt that 1 hour 40 minutes was a risky connection for an international arrival, but among the options presented, this was still the longest layover, so I decided to take it.
...
After finally clearing immigration and collecting my luggage, I walked to the check-in counter for the connecting flight (Counter C in [Terminal 2](https://www.gru.com.br/pt/Passageiros/Descubra-GRU/mapa-do-aeroporto/Paginas/Terminal-2.aspx)). This, however, was difficult to locate. After repeatedly asking staff for directions and walking a long distance, I arrived shortly after 17:30, 30 minutes before departure. I showed my ticket to the counter staff and explained that the departure time was close. They told me, “This flight has already closed check-in. You need to talk to the Ethiopian Airlines and have your ticket changed.”
