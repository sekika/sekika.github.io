...
<script>
    ...
    function drawPlots(theta, h, k, c, iCap) {
        ...
        const layoutTheta = {
            title: { text: 'Pressure Head (-h) vs Water Content (θ)' },
            xaxis: xAxisLayoutLog,
            yaxis: { 
                title: { text: 'Water Content (θ)' }, 
                rangemode: 'tozero',
                gridcolor: '#eee'
            },
            plot_bgcolor: '#fff'
        ...
        const layoutK = {
            title: { text: 'Pressure Head (-h) vs Hydraulic Conductivity (K)' },
            xaxis: xAxisLayoutLog,
            yaxis: { 
                title: { text: 'Hydraulic Conductivity (K)' }, 
                type: 'log',
                exponentformat: 'e',
                gridcolor: '#eee'
            },
        ...
        const layoutThetaK = {
            title: { text: 'Water Content (θ) vs Hydraulic Conductivity (K)' },
            xaxis: {
                title: { text: 'Water Content (θ)' },
                rangemode: 'tozero',
                gridcolor: '#eee'
        ...
        if (iCap === 1) {
            ...
            const layoutC = {
                title: { text: 'Pressure Head (-h) vs Hydraulic Capacity (C)' },
                xaxis: xAxisLayoutLog,
                yaxis: { 
                    title: { text: 'Hydraulic Capacity (C)' }, 
                    type: 'log',
                    exponentformat: 'e',
                    gridcolor: '#eee'
                },
